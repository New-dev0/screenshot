  ...
  return (
    <>
      ...
      <div className={styles.main}>
        ...
        <Row css={{ marginTop: "4rem", marginLeft: "1rem" }} justify="space-between">
          <div className={styles.left} style={{ width: "120vh", marginRight: "30vh", marginTop: "2rem" }}>
          ...
          <Grid className={styles.right}>
            <Card css={{ minWidth: "80vh", background: 'Black' }}>
              <Card.Body>
